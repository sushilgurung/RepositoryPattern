...
### Target Framework
This project is built with .NET 8.0 and uses Entity Framework Core version 8.0.8.

## Installation

Install with .NET CLI
```bash
 dotnet add package Gurung.RepositoryPattern --version 8.0.0
```
Install with Package Manager
```bash
 NuGet\Install-Package Gurung.RepositoryPattern -Version 8.0.0
```
