...
## Target Framework
This project is built with .NET 6.0 and uses Entity Framework Core version 7.0.20.## Installation

Install with .NET CLI
```bash
 dotnet add package Gurung.RepositoryPattern --version 6.0.1
```
Install with Package Manager
```bash
 NuGet\Install-Package Gurung.RepositoryPattern -Version 6.0.1
```
